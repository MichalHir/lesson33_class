class Car:
    ...
    def drive(self, kilometer, fuel_consumption):
        length = kilometer / fuel_consumption
        print("kilometers left:", length)

    # def fuel(self, additional_fuel): # my def
    #     full=100
    #     if not additional_fuel:
    #         self.fuel = full
    #     else:
    #         self.fuel = self.fuel + additional_fuel
    #     print ("fuel left:", self.fuel)
